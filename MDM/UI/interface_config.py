...
class HttpInterfaceConfig:
    ...
    test_get_apk_list_address = "http://192.168.0.30:8080/api/v1/apk/packages"
    test_delete_apk_address = "http://192.168.0.30:8080/api/v1/apk/packages/delete"
    test_upload_apk_address = "http://192.168.0.30:8080/api/v1/upload/apk"
    test_parse_apk_address = "http://192.168.0.30:8080/api/v1/apk/packages/upload"
    test_update_apk_address = "http://192.168.0.30:8080/api/v1/apk/packages/create"
